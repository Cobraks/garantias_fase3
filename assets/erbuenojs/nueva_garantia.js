...
document.addEventListener("DOMContentLoaded", () => {
	...
	// 3. Lógica dinámica de campos (visibilidad, dependencias)
	initDynamicFields();

	// 4. Validación de todos los campos y gestión de errores en tiempo real
	initValidation();

	// 5. Navegación por pestañas y estado del wizard
	initNavigation();

	// 6. Resumen (panel derecho), gestión de errores y edición rápida
	initSummary();

	// 7. Cálculo de tarifas o precios (si existe lógica)
	initCalculations();

	// 8. Botón rellenar datos de ejemplo
	initExampleData();

	// 9. Lógica de envío/finalización
	initSubmission();

	// 10. Lógica de selects dinámicos de usuario/canal (nuevo módulo)
