...
/*
    ...
    Preparado para crecer (tabCompletion, usuario/canal, modalidad seleccionada, etc.)
*/
const FormCache = {
	currentTab: 0,
	tabs: null,
	...
	// Modalidad seleccionada (reemplaza window.selectedPlanIdx)
