(() => {
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        function createOffersDialog(options = {}) {
            ...
            function openAddOfferPicker() {
                const pickerTitle = strings.manageOffersAdd || 'Añadir nueva oferta';
                if (!addOfferPicker) {
                    addOfferPicker = createSimpleDialog({
                        titleKey: '',
                        fallbackTitle: pickerTitle,
                        overlayClass: 'client-dialog--offers-picker',
                        panelClass: 'client-dialog__panel--offers-picker',
                        bodyClass: 'client-offers__add-picker',
                        showFooter: false,
                        onOpen: ({ body: pickerBody }) => {
                            if (!pickerBody) {
                                return;
                            }
                            ...
                            pickerBody.appendChild(options);
                        },
                    });
                }
