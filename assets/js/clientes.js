        ...
        function renderDetail(item) {
            ...
            const manageOffersButton = `
                <div class="client-detail__actions client-detail__actions--inline">
                    <button type="button" class="client-detail__action client-detail__action--secondary" data-manage-offers>
                        ${iconManageOffers}
            ...
            const manageSepaButton = `
                <div class="client-detail__actions client-detail__actions--inline">
                    <button type="button" class="client-detail__action client-detail__action--secondary" data-manage-sepa>
                        ${iconManageSepa}
        ...
        function createAssignDialog() {
            ...
            function renderAssignedList() {
                ...
                const itemsHtml = entries.map((entry) => {
                    ...
                    return `
                        <article class="client-dialog__assigned-card" data-id="${entry.id}">
