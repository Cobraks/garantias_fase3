    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const setModalLoadingState = (loading, label = modalLoadingLabel) => {
            ...
            if (placeholder) {
                ...
                placeholder.style.display = state.modalLoading ? '' : 'none';
            }
            if (modalList) {
            ...
            if (modalLoadMore) {
                ...
                } else if (modalLoadMore.style.display === 'none') {
            ...
            if (loadMoreWrapper) {
                ...
                } else if (!modalLoadMore || modalLoadMore.hidden === false) {
        ...
        const refreshNotifications = ({
            ...
            if (state.modalLoading && Array.isArray(modalItems) && modalItems.length > 0) {
                setModalLoadingState(false);
            } else if (
                !state.modalLoading &&
                state.modalElements &&
                state.modalElements.placeholder
            ) {
                state.modalElements.placeholder.hidden = true;
                state.modalElements.placeholder.setAttribute('aria-hidden', 'true');
            }
