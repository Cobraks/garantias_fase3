...
export default function initAutosave() {
        ...
        async function sendAutosave(finalize = false) {
                ...
                if (finalize || precioBase !== undefined) {
                        ...
                        if (finalize) {
                                ...
                                descuentosYRecargos.listado_descuentos_recargos = staticListado;

                                console.log("[AUTOSAVE] finalize descuentos_y_recargos", {
                                        staticListado,
                                        precioBase,
                                        path: "garantia_contratada.descuentos_y_recargos",
                                });
                        }
