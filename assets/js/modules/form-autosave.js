...
export default function initAutosave() {
        ...
        async function generateProformaAndUpload({
                ...
                if (rowsDrawn > 0) {
                        ...
                        const boxStrokeColor = PDFLib.rgb(0, 0, 0);
                        const textPadding = mmToPt(3);
                        const lineHeight = 10;
                        ...
                        if (showIbanBox) {
                                ...
                                const startX =
                                        rightBoxX + Math.max(textPadding, rightBoxWidth - totalWidth - textPadding);
