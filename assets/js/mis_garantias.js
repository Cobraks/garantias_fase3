                ...
                function updateAdminSummaryKpis(root, context = {}) {
                        ...
                        if (amountCard) {
                                ...
                                if (previousNoteEl) {
                                        ...
                                        if (previousLabel && typeof previousAmount !== "undefined") {
                                                previousNoteEl.textContent = `${previousLabel}: ${formatCurrencyValue(previousAmount)}`;
                        ...
                        if (countCard) {
                                ...
                                if (previousNoteEl) {
                                        if (previousLabel && typeof previousValues.count !== "undefined") {
                                                previousNoteEl.textContent = `${previousLabel}: ${formatIntegerValue(previousValues.count)}`;
                                                previousNoteEl.hidden = false;
                                        } else {
                                                previousNoteEl.textContent = "";
                                                previousNoteEl.hidden = true;
