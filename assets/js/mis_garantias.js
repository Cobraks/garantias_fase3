...
(() => {
    ...
    const formattedAmount = formatAmountForMessage(priceRaw);
           ...
           function initResizableColumns(table) {
                                   ...
                                   if (typeof requestAnimationFrame === "function") {
                                           ...
                                           rafId = requestAnimationFrame(() => {
                                                   ...
                                                   handles.forEach((handle, index) => {
                                                           ...
                                                           handle.style.left = `${th.offsetLeft + th.offsetWidth - 4}px`;
                                                   });
                                           });
                                           return;
                                   }
                                   ...
                                   for (let i = 0; i < widths.length - 1; i++) {
                                           ...
                                           handle.addEventListener("mousedown", (event) => {
                                                   ...
                                                   const onMove = (moveEvent) => {
                                                           ...
                                                           let current = clamp(startWidth + delta, MIN_WIDTH, MAX_WIDTH);
                   ...
                   const ensure = () => {
                           if (minWidthQuery && !minWidthQuery.matches) {
                   ...
                   if (minWidthQuery) {
                           ...
                           if (typeof minWidthQuery.addEventListener === "function") {
                                   minWidthQuery.addEventListener("change", handleMediaChange);
                           } else if (typeof minWidthQuery.addListener === "function") {
                                   minWidthQuery.addListener(handleMediaChange);
                           }
                   }
           }
