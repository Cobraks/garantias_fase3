...
(() => {
        ...
        document.addEventListener("DOMContentLoaded", () => {
                ...
                const DONUT_BASE_COLOR_TOKEN = "var(--donut-base-color)";
    ...
    const formattedAmount = formatAmountForMessage(priceRaw);
        ...
        tr.dataset.compradorTelefono = cliente_telefono_dataset;
                ...
                function normalizeSummaryStates(states) {
                        ...
                        const items = states
                                .map((entry) => {
                                        ...
                                        const label = value === "pendiente_pago" ? "Pend. Pago" : rawLabel;
                ...
                function configureDonutSegments(donut, items) {
                        ...
                        playDonutAnimation(donut);
                }

                function playDonutAnimation(donut) {
                        if (!donut) {
                                return;
                        }
                        donut.style.setProperty("--p", "0");
                        // Fuerza un reflow para reiniciar la animación aunque los datos provengan de caché
                        // o el panel vuelva a mostrarse tras deseleccionar una garantía.
                        void donut.offsetWidth; // eslint-disable-line no-unused-expressions
                ...
                function updateDonutColors(donut, highlightValue) {
                        ...
                        const fallbackColor = highlightSegment
                                ? highlightMuted || highlightColor || "transparent"
                                : DONUT_BASE_COLOR_TOKEN;
