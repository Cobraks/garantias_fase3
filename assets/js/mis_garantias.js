    ...
    const formattedAmount = formatAmountForMessage(priceRaw);
        ...
        tr.dataset.compradorTelefono = cliente_telefono_dataset;
                ...
                function renderAdminSummaryStates(root, context = {}) {
                        ...
                        if (totalEl) {
                                totalEl.textContent = formatIntegerValue(total);
                        }
                        if (labelEl) {
                                const defaultLabel = labelEl.getAttribute("data-default-label") || "Total";
                                const contextLabel = context && typeof context.label === "string" ? context.label.trim() : "";
                                labelEl.textContent = contextLabel || defaultLabel;
                        }
