    ...
    if (isSinFinalizar) {
        ...
        <div class="guarantee-detail__inner">
                ...
                <section class="detail__section detail__section--docs">
                        ...
                        <button type="button" class="detail__docs-btn" data-doc-url="${skeleton("certificate_url", "#")}" aria-label="Ver documento Certificado de garantía">${pdfIcon}<span class="detail__docs-label">Certificado de garantía</span></button>
                        ${hasDocs
