        ...
        document.addEventListener("DOMContentLoaded", () => {
                ...
                const finalizeSpinnerVisibility = (previousCount, appendedRows) => {
                        ...
                        const ensureHide = (attempt = 0) => {
                                ...
                                if (appendedRows > 0 && attempt < 2) {
                                        requestAnimationFrame(() => ensureHide(attempt + 1));
                                        return;
                                }

                                const currentCount = tbody
