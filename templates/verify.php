                    ...
                    <div class="login-card__brand">
                        ...
                        <div class="login-card__header">
                            ...
                            <p class="login-card__subtitle">
                                <?php
                                echo wp_kses(
                                    __('Introduce el código que te enviamos para activar tu cuenta. Si ha caducado, solicita uno nuevo.', 'garantias-online-360vo'),
                                    []
                                );
                                ?>
                            </p>
                        ...
                        <div class="verify-grid">
                            ...
                            <div class="verify-panel verify-panel--code" id="verification-block" hidden>
                                <div class="verify-panel__header">
                                    ...
                                    <div>
                                        <h3 class="verify-panel__title" id="verify-step-label"><?php esc_html_e('Introduce o solicita tu código', 'garantias-online-360vo'); ?></h3>
                                        <p class="verify-panel__eyebrow" id="verify-status-label"></p>
                                    </div>
                                </div>
                                ...
                                <div class="verification-success" id="verification-success" hidden>
                                    ...
                                    <a href="<?php echo esc_url(home_url('/garantias-online/login/')); ?>" class="btn btn-primary verification-success__cta"><?php esc_html_e('Iniciar sesión', 'garantias-online-360vo'); ?></a>
                                </div>
                            </div>
                        </div>
                    </form>
