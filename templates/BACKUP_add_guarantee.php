...
<div class="form-container" style="view-transition-name: garantias-table">
    <div class="tabs">
        ...
        <div class="tabs__link" data-tab="comprador-vendedor">
            ...
            <div class="tabs__title">Datos personales</div>
        </div>
    ...
    <form id="form-garantia" class="form">
        ...
        <fieldset id="datos-comprador-vendedor" class="form__tab-content">
            <fieldset class="form__sub-fieldset">
                <legend style="display:none" class="form__sub-legend">Datos del Comprador</legend>
                <!-- <fieldset class="form__nested-fieldset"> -->
                <legend class="form__nested-legend">Datos personales</legend>
        ...
        <fieldset id="seleccionar-garantia" class="form__tab-content">
            ...
            <div class="form__plans form__plans--featured">
                <!-- Card 1: normal -->
                <div class="form__plan" tabindex="0" role="button">

                    <div class="form__plan-content">
                        <div class="form__plan-title">Essential</div>
                        <div class="form__plan-price-wrapper">
                            <span class="form__plan-price-text">110,70</span>
                            <span class="form__plan-price-euro">€</span>
                        </div>
                        <div class="form__plan-iva">IVA incluido</div>
                        <!-- <div class="form__plan-description">Cobertura básica con todos los elementos esenciales protegidos.</div> -->
                        <div class="form__plan-description">
                            <p>Límite por avería: 800€ (IVA incluido). </p>
                            <p>Límite indemnización por contrato: 1.800€ (IVA incluido).</p>
                        </div>
                        <a class="form__plan-link" href="ruta-al-pdf-essential.pdf" target="_blank">
                            <svg class="form__plan-link-icon" ...></svg>
                            Ver cobertura Essential
                        </a>
                        <button class="form__plan-button" type="button">
                            <!-- <span class="form__plan-button-icon" aria-hidden="true">
                                <?php // echo Svg::icon('check_shield'); 
                                ?>
                            </span> -->
                            <span class="form__plan-button-text">Seleccionar</span>
                        </button>

                    </div>
                </div>
                <!-- Card 2: destacado -->
                <div class="form__plan form__plan--featured selected" tabindex="0" role="button">
                    <div class="form__plan-badge">
                        <!-- <span class="form__plan-badge-icon"><?php // echo Svg::icon('sell'); 
                                                                    ?></span> -->
                        La más vendida
                    </div>
                    <div class="form__plan-content">
                        <div class="form__plan-title">Confort</div>
                        <div class="form__plan-price-wrapper">
                            <span class="form__plan-price-text">210</span>
                            <span class="form__plan-price-euro">€</span>
                        </div>
                        <div class="form__plan-iva">IVA incluido</div>
                        <!-- <div class="form__plan-description">Equilibrio entre cobertura, duración y precio para la mayoría de clientes.</div> -->
                        <div class="form__plan-description">
                            <p>Límite por avería: 1600€ (IVA incluido). </p>
                            <p>Límite indemnización por contrato: Valor Venal del vehículo en el momento de la avería.</p>
                        </div>
                        <!-- <ul class="form__plan-list">
                            <li> Motor </li>
                            <li> Alimentación y encendido </li>
                            <li> Transmisión</li>
                            <li> Diferencial</li>
                            <li> Sistema eléctrico y/o electrónico</li>
                            <li> Alternador, motor de arranque, etc </li>
                            <li> Dirección </li>
                            <li> Sistema de Frenos </li>
                            <li> ABS </li>
                            <li> Aire acondicionado, climatizador y calefación </li>
                            <li> Motor </li>
                         </ul> -->
                        <a class="form__plan-link" href="ruta-al-pdf-essential-plus.pdf" target="_blank">
                            <svg class="form__plan-link-icon" ...></svg>
                            Ver cobertura Confort
                        </a>
                        <button class="form__plan-button" type="button">
                            <!-- <span class="form__plan-button-icon" aria-hidden="true">
                                <?php // echo Svg::icon('check_shield'); 
                ...
                <!-- Card 3: normal y seleccionada -->
                <div class="form__plan form__plan--premium" tabindex="0" role="button">
                    <!-- <div class="form__plan-badge">
                        <span class="form__plan-badge-icon"><?php // echo Svg::icon('premium'); 
                                                            ?></span>
                        Recomendado
                    </div> -->
                    <div class="form__plan-badge">
                    ...
                    <div class="form__plan-content">
                        <div class="form__plan-title">Exclusive</div>
                        <div class="form__plan-price-wrapper">
                            <span class="form__plan-price-text">280</span>
                            <span class="form__plan-price-euro">€</span>
                        </div>
                        <div class="form__plan-iva">IVA incluido</div>
                        <!-- <div class="form__plan-description">Máxima cobertura con extras y asistencia VIP.</div> -->
                        <div class="form__plan-description">
                            <p>Límite por avería vehículos hasta 10 años y 200.000km: 3200€ (IVA incluido). </p>
                            <p>Límite por avería vehículos de más de 10 años y más de 200.000km: 2500€ (IVA incluido). </p>
                            <p>Límite indemnización por contrato: Valor Venal del vehículo en el momento de la avería.</p>
                        </div>
                        <a class="form__plan-link" href="ruta-al-pdf-exclusive.pdf" target="_blank">
                            <svg class="form__plan-link-icon" ...></svg>
                            Ver cobertura Exclusive
                        </a>
                        <button class="form__plan-button" type="button">
                            <!-- <span class="form__plan-button-icon" aria-hidden="true">
                                <?php // echo Svg::icon('check_shield'); 
...
<aside class="summary-container" style="view-transition-name: resume-derecha">
    ...
    <div class="summary-section summary-section--cliente">
        ...
        <button class="summary-button">Editar datos personales</button>
    </div>
