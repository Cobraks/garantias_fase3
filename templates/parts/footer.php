...
<?php if ($is_clients_page ?? false) : ?>
    ...
    $clients_config = [
        ...
        'strings' => [
            ...
            'notificationEmailDifferent' => __('Email distinto al de inicio de sesión', 'garantias-online-360vo'),
            ...
            'adminLink'            => __('Ver ficha del cliente en el panel de gestión', 'garantias-online-360vo'),
