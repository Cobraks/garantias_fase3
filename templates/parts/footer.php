...
<?php if ($is_clients_page ?? false) : ?>
    ...
    $clients_config = [
        ...
        'strings' => [
            ...
            'deleteUserHasGuarantees' => __('Este usuario tiene %s garantías.', 'garantias-online-360vo'),
            'deleteUserCannotDelete'  => __('No puedes eliminarlo desde aquí, contacta con el Departamento de Desarrollo y Programación', 'garantias-online-360vo'),
            'deleteUserFinalCheckbox' => __('Confirmo que quiero eliminar definitivamente a este usuario.', 'garantias-online-360vo'),
            'deleteUserSure'          => __('Estoy seguro', 'garantias-online-360vo'),
            'deleteUserDeleting'      => __('Eliminando usuario', 'garantias-online-360vo'),
            'deleteUserError'         => __('No se ha podido eliminar al usuario. Inténtalo de nuevo o contacta con soporte.', 'garantias-online-360vo'),
