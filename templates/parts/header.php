...
$preferences_url = apply_filters('go360/profile/preferences_url', home_url('/garantias-online/preferencias/'));
                    ...
                    >
                        ...
                        <div class="profile-menu__list" role="none">
                            <a
                                ...
                                role="menuitem"
                            >
                                <?php echo Svg::icon('edit', 'profile-menu__icon'); ?>
                                <span class="profile-menu__text"><?php esc_html_e('Mi cuenta', 'garantias-online-360vo'); ?></span>
                            </a>
                            <?php if (! empty($preferences_url)) : ?>
                                <a
                                    href="<?php echo esc_url($preferences_url); ?>"
                                    class="profile-menu__item"
                                    role="menuitem"
                                >
                                    <?php echo Svg::icon('settings', 'profile-menu__icon'); ?>
                                    <span class="profile-menu__text"><?php esc_html_e('Preferencias', 'garantias-online-360vo'); ?></span>
                                </a>
                            <?php endif; ?>
                        </div>
