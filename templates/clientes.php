...
<div class="guarantees-container">
    <section class="guarantees-list">
        <table class="guarantees-table" style="view-transition-name: garantias-table">
            <thead>
                <tr>
                    <th><?php esc_html_e('Perfil', 'garantias-online-360vo'); ?></th>
                    ...
                    <th><?php esc_html_e('Número de garantías', 'garantias-online-360vo'); ?></th>
                    <th><?php esc_html_e('Tipo de pago', 'garantias-online-360vo'); ?></th>
                    <th><?php esc_html_e('Comercial asignado', 'garantias-online-360vo'); ?></th>
                </tr>
            </thead>
