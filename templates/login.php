...
<main class="register-page login-page" style="view-transition-name: login">
    <style>
        ...
        .login-card__badge {
            ...
            border-radius: 999px;
            background: linear-gradient(180deg, rgba(255, 240, 242, 0.92), rgba(255, 226, 230, 0.92));
            border: 1px solid rgba(197, 68, 78, 0.25);
            box-shadow: 0 18px 32px -24px rgba(197, 68, 78, 0.65);
            color: #c5444e;
            font-size: 0.78rem;
            font-weight: 600;
