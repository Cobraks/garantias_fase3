...
<div
    ...
    <div class="guarantees-list__toolbar">
        <div class="guarantees-list__search-container">
            ...
            <button
                type="button"
                class="guarantees-list__clear-search"
                data-clear-search
                hidden
                aria-label="<?php esc_attr_e('Limpiar búsqueda', 'garantias-online-360vo'); ?>">
                <?php echo Svg::icon('cerrar'); ?>
            </button>
        </div>

        <div class="guarantees-list__toolbar-actions">
            ...
            <button
                ...
                data-filters-toggle
                aria-expanded="false"
                aria-controls="guarantees-filters-panel">
                ...
                <span class="guarantees-list__mobile-trigger-caret" aria-hidden="true">
                    <?php echo Svg::icon('arrow_drop_down'); ?>
                </span>
            </button>
        </div>
    ...
    <div class="guarantees-list__filters-backdrop" data-filters-backdrop hidden></div>

    <div
        class="guarantees-list__filters-panel"
        id="guarantees-filters-panel"
        data-filters-panel
        aria-hidden="true">
        <div class="guarantees-list__panel-header">
            <h2 class="guarantees-list__panel-title">
                <?php esc_html_e('Filtros', 'garantias-online-360vo'); ?>
            </h2>
            <button
                type="button"
                class="guarantees-list__panel-close"
                data-filters-close
        ...
        <div class="guarantees-list__panel-scroll">
