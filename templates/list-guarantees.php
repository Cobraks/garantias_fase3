            ...
            <section class="guarantee-admin-summary is-loading" data-admin-summary data-loaded="0" data-loading="1">
                ...
                <div class="guarantee-admin-summary__body">
                    <article class="guarantee-admin-summary__visual">
                        <div class="guarantee-admin-summary__donut" data-admin-summary-donut>
                            <div class="guarantee-admin-summary__donut-center">
                                <span class="guarantee-admin-summary__donut-count" data-admin-summary-total>&mdash;</span>
                                <span class="guarantee-admin-summary__donut-label"><?php esc_html_e('Garantías', 'garantias-online-360vo'); ?></span>
                            </div>
                        </div>
                        <ul class="guarantee-admin-summary__legend" data-admin-summary-states>
                            <li class="guarantee-admin-summary__legend-item is-loading">
                                <span class="guarantee-admin-summary__legend-label"><?php esc_html_e('Cargando distribución…', 'garantias-online-360vo'); ?></span>
                            </li>
                        </ul>
                    </article>
                    <div class="guarantee-admin-summary__insights">
                        <article class="guarantee-admin-summary__panel guarantee-admin-summary__panel--pending">
                            <header class="guarantee-admin-summary__panel-header">
                                <h5 class="guarantee-admin-summary__panel-title"><?php esc_html_e('Seguimiento', 'garantias-online-360vo'); ?></h5>
                            </header>
                            <ul class="guarantee-admin-summary__metric-list" data-admin-summary-pending>
                                <li class="guarantee-admin-summary__metric is-loading"></li>
                                <li class="guarantee-admin-summary__metric is-loading"></li>
                                <li class="guarantee-admin-summary__metric is-loading"></li>
                            </ul>
                        </article>
                        <article class="guarantee-admin-summary__panel guarantee-admin-summary__panel--month">
                            <header class="guarantee-admin-summary__panel-header">
                                <h5 class="guarantee-admin-summary__panel-title"><?php esc_html_e('Mes en curso', 'garantias-online-360vo'); ?></h5>
                                <span class="guarantee-admin-summary__panel-subtitle" data-admin-summary-month-label>&mdash;</span>
                            </header>
                            ...
                            <div class="guarantee-admin-summary__mini-chart" data-admin-summary-month-chart>
