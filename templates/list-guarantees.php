            ...
            <div class="guarantee-management__shell">
                <header class="guarantee-management__header">
                    <div class="guarantee-management__topline">
                        <div class="guarantee-management__title-row">
                            <h2 class="guarantee-management__title" id="guarantee-management-title">
                                <?php esc_html_e('Gestión de garantía', 'garantias-online-360vo'); ?>
                            </h2>
                            <span class="guarantee-management__plate" data-management-plate>— — —</span>
                            <div class="guarantee-management__status" data-management-status>
                                <span class="guarantee-management__badge guarantee-detail__badge guarantee-detail__badge--pendiente" data-management-status-badge>
                                    <span class="guarantee-management__status-indicator" aria-hidden="true"></span>
                    ...
                    <div class="guarantee-management__details">
                        <div class="guarantee-management__detail-item">
                            <span class="guarantee-management__detail-label"><?php esc_html_e('Vehículo', 'garantias-online-360vo'); ?></span>
                            <span class="guarantee-management__detail-value" data-management-vehicle>—</span>
                        </div>
                        <div class="guarantee-management__detail-item">
                            <span class="guarantee-management__detail-label"><?php esc_html_e('Vendedor', 'garantias-online-360vo'); ?></span>
                            <span class="guarantee-management__detail-value" data-management-vendor>—</span>
                        </div>
                        <div class="guarantee-management__detail-item">
                            <span class="guarantee-management__detail-label"><?php esc_html_e('Válido hasta', 'garantias-online-360vo'); ?></span>
                            <span class="guarantee-management__detail-value" data-management-valid-until>—</span>
                        </div>
                        <div class="guarantee-management__detail-item">
                            <span class="guarantee-management__detail-label"><?php esc_html_e('Cobertura', 'garantias-online-360vo'); ?></span>
                            <span class="guarantee-management__detail-value" data-management-coverage>—</span>
                        </div>
                    </div>
                </header>
                <div class="guarantee-management__content">
                    <div class="guarantee-management__grid">
                        <section class="management-actions" aria-label="<?php esc_attr_e('Acciones de gestión', 'garantias-online-360vo'); ?>">
                            <h3 class="management-actions__title"><?php esc_html_e('Acciones de gestión', 'garantias-online-360vo'); ?></h3>
                            <div class="management-actions__list" role="list">
                                ...
                                <button
                                    ...
                                    <span class="management-actions__copy">
                                        <strong><?php esc_html_e('Editar en WordPress', 'garantias-online-360vo'); ?></strong>
                        ...
                        <section class="management-notes" aria-live="polite">
                            <div class="management-notes__header">
                                <div>
                                    <p class="management-notes__title"><?php esc_html_e('Notas internas', 'garantias-online-360vo'); ?></p>
                                    <small class="management-notes__subtitle"><?php esc_html_e('Solo visibles para el equipo', 'garantias-online-360vo'); ?></small>
                                </div>
                            </div>
                            <div class="management-notes__list" data-management-notes>
                                <article class="management-notes__item">
                                    <div class="management-notes__meta">
                                        ...
                                        <time class="management-notes__time" datetime="2024-05-12T09:24:00+02:00">12/05/2024 · 09:24</time>
                                    </div>
                                    <p class="management-notes__body"><?php esc_html_e('Revisamos el certificado y está pendiente de una actualización de datos.', 'garantias-online-360vo'); ?></p>
                                </article>

                                <article class="management-notes__item">
                                    <div class="management-notes__meta">
                                        <span class="management-notes__author"><?php esc_html_e('Verónica · Asesoría', 'garantias-online-360vo'); ?></span>
                                        <time class="management-notes__time" datetime="2024-05-15T16:42:00+02:00">15/05/2024 · 16:42</time>
                                    </div>
                                    <p class="management-notes__body"><?php esc_html_e('Cliente envía documentación de pago. Falta validar la matrícula con DGT.', 'garantias-online-360vo'); ?></p>
                                </article>

                                <article class="management-notes__item management-notes__item--own">
                                    <div class="management-notes__meta">
                                        <span class="management-notes__author"><?php esc_html_e('Julián Martínez', 'garantias-online-360vo'); ?></span>
                                        <time class="management-notes__time" datetime="2024-05-16T10:07:00+02:00">16/05/2024 · 10:07</time>
                                    </div>
                                    <p class="management-notes__body"><?php esc_html_e('He actualizado los datos del vehículo; queda confirmar el pago.', 'garantias-online-360vo'); ?></p>
                                    <div class="management-notes__actions" aria-label="<?php esc_attr_e('Acciones de nota', 'garantias-online-360vo'); ?>">
                                        <button type="button" class="management-notes__action management-notes__action--ghost"><?php esc_html_e('Editar', 'garantias-online-360vo'); ?></button>
                                        <button type="button" class="management-notes__action management-notes__action--danger"><?php esc_html_e('Eliminar', 'garantias-online-360vo'); ?></button>
                                    </div>
                                </article>
                                ...
                                <article class="management-notes__item management-notes__item--own">
                                    <div class="management-notes__meta">
                                        <span class="management-notes__author"><?php esc_html_e('Julián Martínez', 'garantias-online-360vo'); ?></span>
                                        <time class="management-notes__time" datetime="2024-05-18T18:22:00+02:00">18/05/2024 · 18:22</time>
                                    </div>
                                    <p class="management-notes__body"><?php esc_html_e('Pago confirmado en pasarela. Envío recordatorio para validar la póliza.', 'garantias-online-360vo'); ?></p>
                                    <div class="management-notes__actions" aria-label="<?php esc_attr_e('Acciones de nota', 'garantias-online-360vo'); ?>">
                                        <button type="button" class="management-notes__action management-notes__action--ghost"><?php esc_html_e('Editar', 'garantias-online-360vo'); ?></button>
                                        <button type="button" class="management-notes__action management-notes__action--danger"><?php esc_html_e('Eliminar', 'garantias-online-360vo'); ?></button>
                                    </div>
                            ...
                            <div class="management-notes__composer">
                                <label class="screen-reader-text" for="management-note-input">
                                    <?php esc_html_e('Añadir nota interna', 'garantias-online-360vo'); ?>
                                </label>
                                <textarea
                                    id="management-note-input"
                                    class="management-notes__textarea"
                                    rows="3"
                                    placeholder="<?php esc_attr_e('Escribe una nota breve para el equipo...', 'garantias-online-360vo'); ?>"
                                ></textarea>
