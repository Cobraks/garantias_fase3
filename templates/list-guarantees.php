...
<!-- 1. FILTROS -->
<div class="guarantees-list__filters" data-mobile-open="false" style="view-transition-name: filtros">
    <div class="guarantees-list__filters-row">
        ...
        <button
            type="button"
            class="guarantees-list__mobile-trigger"
            data-mobile-filters-trigger
            aria-haspopup="dialog"
            aria-expanded="false"
            aria-controls="guarantees-mobile-filters">
            <?php echo Svg::icon('filter_funnel', 'guarantees-list__mobile-trigger-icon'); ?>
            <span class="guarantees-list__mobile-trigger-label">
                <?php esc_html_e('Filtros', 'garantias-online-360vo'); ?>
            </span>
        </button>

        <div
            class="guarantees-list__filters-controls"
            data-mobile-filters-body
            id="guarantees-mobile-filters"
            role="dialog"
            aria-modal="true"
            aria-labelledby="guarantees-mobile-filters-title"
            aria-hidden="true">
            <div class="guarantees-list__filters-controls-header">
                <h2 class="guarantees-list__filters-title" id="guarantees-mobile-filters-title">
                    <?php esc_html_e('Filtros', 'garantias-online-360vo'); ?>
                </h2>
                <button
                    type="button"
                    class="guarantees-list__mobile-close"
                    data-mobile-filters-close
                    aria-label="<?php esc_attr_e('Cerrar filtros', 'garantias-online-360vo'); ?>">
                    <?php echo Svg::icon('cerrar'); ?>
                </button>
            </div>

            <div class="guarantees-list__filters-controls-content">
                <div class="guarantees-list__filters-main">
                    <select
    ...
    <div class="guarantees-list__filters-backdrop" data-mobile-filters-backdrop aria-hidden="true"></div>
</div>
