    ...
    <div class="guarantee-detail__empty" data-empty-detail data-empty-mode="awaiting">
        ...
        <?php if ($can_view_summary) : ?>
            ...
            if ($admin_summary_context_key === 'global') {
                ...
                $summary_amount_label = __('Valor anual', 'garantias-online-360vo');
                $summary_count_label = __('Garantías del año', 'garantias-online-360vo');
            } else {
            ...
            $summary_previous_count_text = $summary_previous_label !== ''
                ? sprintf('%s: %s', $summary_previous_label, $format_summary_number($summary_previous_count))
                : '';
                        ...
                        <section class="kpi-grid" data-admin-summary-kpis>
                            <article class="kpi-card" data-admin-summary-kpi="amount">
                                ...
                                <div
                                    ...
                                    data-prev-type="amount"<?php echo $summary_previous_amount_text !== '' ? '' : ' hidden'; ?>>
                                    <?php
                            ...
                            <article class="kpi-card" data-admin-summary-kpi="count">
                                ...
                                <div
                                    class="kpi-previous-note"
                                    data-admin-summary-prev-note
                                    data-prev-type="count"<?php echo $summary_previous_count_text !== '' ? '' : ' hidden'; ?>>
                                    <?php
                        ...
                        <section class="management-notes" aria-live="polite">
                            ...
                            <div class="management-notes__composer">
                                ...
                                <div class="management-notes__composer-actions">
                                    ...
                                    <button
                                        type="button"
                                        class="guarantee-management__btn guarantee-management__btn--primary"
                                        data-management-save-note
                                    >
                                        <span class="guarantee-management__btn-icon" aria-hidden="true"><?php echo Svg::icon('save'); ?></span>
                                        <span data-management-save-label><?php esc_html_e('Guardar nota', 'garantias-online-360vo'); ?></span>
                                    </button>
                                </div>
                            </div>
                        </section>
    ...
    <div class="confirm-modal__dialog" role="dialog" aria-modal="true" aria-labelledby="confirm-modal-title">
        ...
        <div class="confirm-modal__intro">
            ...
            <div class="confirm-modal__cancel-fields" hidden>
                ...
                <select id="confirm-modal-cancel-reason" class="confirm-modal__select" data-confirm-cancel-reason="">
                    <option value="" disabled selected>
                        <?php esc_html_e('Selecciona un motivo', 'garantias-online-360vo'); ?>
                    </option>
                </select>
                <div class="confirm-modal__field confirm-modal__other-reason" hidden>
                    <label class="confirm-modal__field-label" for="confirm-modal-cancel-other">
                        <?php esc_html_e('Escribe el motivo de la cancelación', 'garantias-online-360vo'); ?>
                    </label>
                    <input
                        id="confirm-modal-cancel-other"
                        type="text"
                        class="confirm-modal__input"
                        data-confirm-cancel-other=""
                        placeholder="<?php esc_attr_e('Motivo de la cancelación', 'garantias-online-360vo'); ?>"
                    />
                </div>
            </div>
        ...
        <label class="confirm-modal__checkbox confirm-modal__checkbox--notify" hidden>
            <input
                type="checkbox"
                class="confirm-modal__checkbox-input confirm-modal__checkbox-input--notify"
                id="<?php echo esc_attr($confirm_checkbox_id); ?>-notify"
                name="<?php echo esc_attr($confirm_checkbox_name); ?>-notify"
            />
