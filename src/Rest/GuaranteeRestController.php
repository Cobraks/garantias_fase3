...
class GuaranteeRestController
{
    ...
    private static function collect_year_summary(array $statuses): array
    {
        ...
        $comparison_label = self::format_comparison_date_label($now);
        $trend_label = sprintf(
            __('vs año ant. · Comparación al %s', 'garantias-online-360vo'),
            $comparison_label
        );
    ...
    private static function collect_month_summary(array $statuses): array
    {
        ...
        $comparison_label = self::format_comparison_date_label($now);
        $trend_label = sprintf(
            __('vs mes ant. · Comparación al %s', 'garantias-online-360vo'),
            $comparison_label
        );
