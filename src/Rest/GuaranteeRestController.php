...
class GuaranteeRestController
{
    ...
    private static $list_cache_generation = null;
    ...
    {
        if (self::$list_cache_generation !== null) {
            return self::$list_cache_generation;
        }
        ...
        self::$list_cache_generation = $generation;
    ...
    private static function bump_list_cache_generation(): int
    {
        ...
        self::$list_cache_generation = $next_generation;
